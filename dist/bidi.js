(function (global, factory) {
  ...
  var bidi = (function (exports) {
    ...
    function stringToArray (string) {
      return [].concat( new Intl.Segmenter().segment(string) ).map(function (x) { return x.segment; });
    }
     ...
     * @return {GetEmbeddingLevelsResult}
     */
    function getEmbeddingLevelsForCharacters (characters, baseDirection) {
      var MAX_DEPTH = 125;

      // Start by mapping all characters to their unicode type, as a bitmask integer
      var charTypes = new Uint32Array(characters.length);
      ...
      var embedLevels = new Uint8Array(characters.length);
      ...
      var paragraph = null;
      for (var i$1 = 0; i$1 < characters.length; i$1++) {
        if (!paragraph) {
      ...
      for (var paraIdx = 0; paraIdx < paragraphs.length; paraIdx++) {
            ...
            var bracketPairs = [];
            {
              ...
              for (var si$7 = 0; si$7 < seqIndices$1.length; si$7++) {
                ...
                if (charTypes[seqIndices$1[si$7]] & NEUTRAL_ISOLATE_TYPES) {
                  var char = characters[seqIndices$1[si$7]];
                ...
                if (useStrongType !== embedDirection) {
                  for (var si$10 = openSeqIdx + 1; si$10 < seqIndices$1.length; si$10++) {
                    if (!(charTypes[seqIndices$1[si$10]] & BN_LIKE_TYPES)) {
                      if (getBidiCharType(characters[seqIndices$1[si$10]]) & TYPE_NSM) {
                ...
                if (useStrongType !== embedDirection) {
                  for (var si$11 = closeSeqIdx + 1; si$11 < seqIndices$1.length; si$11++) {
                    if (!(charTypes[seqIndices$1[si$11]] & BN_LIKE_TYPES)) {
                      if (getBidiCharType(characters[seqIndices$1[si$11]]) & TYPE_NSM) {
        ...
        for (var i$17 = paragraph.start; i$17 <= paragraph.end; i$17++) {
          ...
          if (i$17 === paragraph.end || getBidiCharType(characters[i$17]) & (TYPE_S | TYPE_B)) {
            for (var j$1 = i$17; j$1 >= 0 && (getBidiCharType(characters[j$1]) & TRAILING_TYPES); j$1--) {
      ...
      function indexOfMatchingPDI (isolateStart) {
        ...
        for (var i = isolateStart + 1; i < characters.length; i++) {
          var charType = charTypes[i];
          if (charType & TYPE_B) {
            break
          }
     ...
     */
    function getMirroredCharactersMap(characters, embeddingLevels, start, end) {
      ...
      for (var i = start; i <= end; i++) {
        if (embeddingLevels[i] & 1) { //only odd (rtl) levels
          var mirror = getMirroredCharacter(characters[i]);
          if (mirror !== null) {
            map.set(i, mirror);
          }
        }
     ...
     */
    function getReorderSegments(characters, embeddingLevelsResult, start, end) {
      var strLen = characters.length;
      start = Math.max(0, start == null ? 0 : +start);
      end = Math.min(strLen - 1, end == null ? strLen - 1 : +end);
      ...
      embeddingLevelsResult.paragraphs.forEach(function (paragraph) {
        ...
        if (lineStart < lineEnd) {
          ...
          for (var i = lineEnd; i >= lineStart && (getBidiCharType(characters[i]) & TRAILING_TYPES); i--) {
     ...
     */
    function getReorderedCharacters(characters, embedLevelsResult, start, end) {
      var result = [];
      var indices = getReorderedIndices(characters, embedLevelsResult, start, end);
     ...
     */
    function getReorderedIndices(characters, embedLevelsResult, start, end) {
      var segments = getReorderSegments(characters, embedLevelsResult, start, end);
    ...
    exports.getEmbeddingLevelsForCharacters = getEmbeddingLevelsForCharacters;
    exports.getMirroredCharacter = getMirroredCharacter;
    exports.getMirroredCharactersMap = getMirroredCharactersMap;
    exports.getReorderSegments = getReorderSegments;
    exports.getReorderedCharacters = getReorderedCharacters;
